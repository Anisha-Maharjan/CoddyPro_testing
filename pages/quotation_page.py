...
class QuotationPage(BasePage):
    ...
    CREATED_MESSAGE = (
        By.XPATH,
        "//*[@id='root']/section/ol/li[contains(., 'Quotation') and contains(., 'submitted')]",
    )
    ...
    def select_customer(self, customer_name: str):
        ...
        self.type_text(self.SEARCH_INPUT, customer_name)
    ...
    def is_quotation_created(self, timeout: int = 10) -> bool:
        return self.is_visible(self.CREATED_MESSAGE, timeout=timeout)

    def create_quotation(self, customer_name: str, item_name: str):
